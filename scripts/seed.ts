...
async function seedPages() {
  ...
  const pages = [
    { slug: 'about', title: 'درباره ارکید', showInFooter: true, sortOrder: 0, body: '<p>ارکید با هدف ارائه لباس زیر زنانه باکیفیت، راحت و زیبا شکل گرفت.</p>' },
    { slug: 'contact', title: 'تماس با ما', showInFooter: true, sortOrder: 1, body: '<p>برای ارتباط با پشتیبانی ارکید از راه‌های زیر اقدام کنید.</p>' },
    { slug: 'faq', title: 'سوالات متداول', showInFooter: true, sortOrder: 2, body: '<h2>چگونه سایز مناسب را انتخاب کنم؟</h2><p>راهنمای سایز در صفحه هر محصول قرار دارد.</p>' },
